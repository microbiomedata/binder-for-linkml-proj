...
examples/output: src/binder_for_linkml_proj/schema/binder_for_linkml_proj.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/binder_for_linkml_proj/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
